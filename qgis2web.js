...
map.getView().fit([11962876.054923, -780353.921607, 12003592.461951, -760023.675059], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Tutupan Lahan Wilayah Administrasi Kota Bandung</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (68 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini menampikan tutupan lahan wilayah administrasi Kota Bandung.';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_Kota_BandungADMNew_2,
    colName: 'WADMKC',
    zoom: 10,
    collapsed: true,
    map: map,
